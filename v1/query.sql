CREATE DATABASE Backend_v1_IM;
CREATE USER 'Backend_v1_IM'@'localhost' IDENTIFIED BY 'evaluacion1';
GRANT ALL PRIVILEGES ON ciisa_backend_v1 . * TO 'Backend_v1_IM'@'localhost';
FLUSH PRIVILEGES;
